                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-gray-500 font-black uppercase tracking-widest mt-1">
                      {req.systemName} • {req.subscriptionType} • {req.createdAt ? new Date(req.createdAt).toLocaleDateString('ar-EG') : 'N/A'}
                    </p>
                  </div>
                </div>
        ...
        <div className="bg-white p-10 rounded-[3.5rem] flex flex-col justify-between shadow-2xl relative overflow-hidden group">
          ...
          <div className="mt-12 space-y-2">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-5xl font-black text-black tracking-tighter">{(totalCommission || 0).toLocaleString()}</span>
